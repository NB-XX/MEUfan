...
from meufan_core import KNOWN_LANGS, LANG_LABELS, normalize_srt_ref, extract_lang, parse_srt_text
...
def main():
    ...
    for ci, csv_entry in enumerate(csv_entries):
        entry = {
            ...
            'youtubeUrl': f'https://www.youtube.com/watch?v={csv_entry["video_id"]}',
